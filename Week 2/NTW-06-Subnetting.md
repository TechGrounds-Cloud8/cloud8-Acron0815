...
## Key terminology
I don't want to delve too far into why or when subnetting is needed, as this article will focus primarily on computation. In short, subnetting brings the following benefits:

 - Divide larger network into small subnets
 - Increase performance and overview in general in the network
Subnetting divides a network into several smaller subnets. The opposite of this would be supernetting. In other words, supernetting increases the maximum number of hosts in the network or combines several networks.
